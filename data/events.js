...
const EVENTS = [
  ...
  },
  {
    ...
    narrative: [
      "Han pasado dos semanas desde tu reclutamiento y los líderes patriotas han observado tus movimientos con la misma atención con que un orfebre estudia el oro. Esta noche, en una casa de la calle Reconquista, Belgrano mismo te convoca.",
  ...
  },
  {
    ...
    narrative: [
      "En una ceremonia de la Primera Junta —la primera celebración formal de sus logros iniciales— Cornelio Saavedra pronuncia un discurso que nadie esperaba. En medio de los agradecimientos institucionales, menciona tu nombre específicamente. Te describe como alguien cuyo trabajo en las sombras ha sido tan vital como el de quienes aparecen en los documentos oficiales.",
  ...
  },
  {
    ...
    narrative: [
      ...
      "Pero algo quedó de aquel mayo: la ruptura. El quiebre con la idea de que el orden colonial era natural e inevitable. La afirmación —peligrosa, costosa, irreversible— de que el poder reside en el pueblo y no en un rey cautivo en Europa. Esa idea, que Moreno articuló y Castelli proclamó en Tiahuanaco y Belgrano defendió desobedeciendo órdenes en Tucumán y Saavedra avaló con sus tropas en la plaza —esa idea no murió con ninguno de ellos. Llegó hasta acá. Llegó hasta vos. Lo que hacés con ella es, en algún sentido, la continuación de la historia que empezó aquella noche en que un extraño te abordó en la Iglesia del Pilar."
    ],
    choices: [
