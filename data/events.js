...
const EVENTS = [
  ...
  },
  {
    ...
    narrative: [
      "El Cabildo Abierto del 22 de mayo es un campo de batalla que parece una sala de reunión. El Cabildo repartíó cuatrocientas cincuenta invitaciones entre los vecinos principales, y doscientos cincuenta y uno se presentaron a votar sobre el destino del Virrey Cisneros. Afuera, la plaza ya tiene gente apostada desde el amanecer, muchos con las cintas que French y Beruti distribuyeron. Adentro, el debate es feroz.",
      ...
      "Tu rol hoy no es votar —no sos de los doscientos cincuenta y uno— sino manejar la presión exterior. La multitud en la plaza necesita señales de lo que ocurre adentro para mantenerse cohesionada. Si la gente se dispersa, el Cabildo puede ignorar el peso popular.",
  ...
  },
  {
    ...
    narrative: [
      "Ayer el Cabildo terminó de contar los votos del Cabildo Abierto. Hoy anuncia lo que hizo con ellos, y es un golpe para los patriotas: Cisneros no fue destituido. En cambio se formó una Junta presidida por el propio Virrey, con Saavedra, Castelli, Solá e Inchaurregui de vocales. Es una maniobra que parece una concesión pero es, en realidad, un vaciamiento de la revolución.",
      "El movimiento patriota reacciona con indignación. Moreno está furioso con una frialdad que asusta más que el enojo. Belgrano dice que esto no puede aceptarse. Saavedra y Castelli, que figuran como vocales de esa junta, ya avisaron que renuncian: Cisneros al frente de cualquier gobierno hace imposible el cambio real. La junta que nació esta mañana no va a llegar entera al amanecer.",
      "La tarea de esta noche es organizar una nueva presión coordinada: los cuerpos militares patriotas deben negarse a obedecer a la Junta fraudulenta, los comerciantes criollos deben cerrar sus tiendas en señal de protesta, y la plaza debe llenarse nuevamente mañana —el 25— con una demanda clara: Cisneros fuera, sin condiciones.",
  ...
  // ACT II: LA REVOLUCIÓN
  {
    ...
    narrative: [
      "Ha sucedido. Cornelio Saavedra acaba de ser designado Presidente de la Primera Junta de Gobierno del Río de la Plata. A su lado, seis vocales —Juan José Castelli, Manuel Belgrano, Miguel de Azcuénaga, el presbítero Manuel Alberti, Domingo Matheu y Juan Larrea— y dos secretarios: Mariano Moreno y Juan José Paso. Nueve hombres que hoy cargan el peso de una nación que aún no sabe que existe.",
  ...
  // ============================================================
  {
    ...
    narrative: [
      ...
      "Te llega la noticia de su partida por un contacto en el puerto. No hubo ceremonias públicas. Moreno abordó la fragata inglesa 'La Fama' el 24 de enero de 1811, en La Ensenada, con dos baúles de libros, una fiebre que arrastraba desde diciembre, y una certeza que no puso en los papeles oficiales. Sus últimas palabras en tierra argentina, según quien estuvo presente, fueron para el criado que lo acompañaba al muelle: 'Cuidá los libros. Los libros son lo único que no va a traicionarme.'",
      "El 4 de marzo de 1811, en alta mar, Mariano Moreno murió. Tenía treinta y dos años. El médico del barco informó que la causa fue una fiebre aguda agravada por el frío del Atlántico. Otros dijeron que el capitán de 'La Fama' administró una dosis de tártaro emético —un purgante que en cantidades altas es letal— bajo instrucciones de Buenos Aires. Nadie fue juzgado. La verdad se hundió con su cuerpo en el océano.",
  ...
  },
  {
    ...
    narrative: [
      ...
      "Menos de un mes después, el 20 de junio de 1811, el ejército patriota es derrotado en Huaqui con una contundencia que no deja margen a interpretación. Miles de muertos. El Alto Perú vuelve a manos realistas. Las razones serán debatidas durante décadas: que los hombres estaban mal armados, que fue traicionado, que sus proclamas radicales enajenaron a los aliados locales que necesitaba. Probablemente todo sea cierto y nada alcance para explicar completamente lo que ocurrió en ese campo.",
      "Castelli regresa a Buenos Aires para enfrentar un tribunal militar. Pero antes de que el tribunal dicte veredicto, su cuerpo dicta el propio: desarrolla un cáncer de lengua que avanza con la velocidad que suelen tener las cosas que se llevan a los hombres que más hablan. Le amputan la lengua y para 1812 ya no puede hablar: se defiende por escrito. El tribuno de Mayo, cuya voz movió masas en el momento más crítico, pasa sus últimos meses en silencio forzado en una ciudad que ya está pensando en otra cosa.",
      "Muere el 12 de octubre de 1812. Tiene cuarenta y ocho años. En sus papeles encuentran anotaciones a medio terminar sobre lo que hubiera dicho al tribunal si hubiera podido hablar. Lo que te queda de él no es Huaqui, que es la parte que todos conocen. Lo que te queda es Tiahuanaco: ese momento en que alguien proclamó que la revolución también era para los que nadie había invitado a la reunión de la Jabonería."
    ],
    choices: [
  ...
  },
  {
    ...
    narrative: [
      ...
      "Lo acusaron de conspirar. Lo exiliaron a Mendoza. Pasó por San Juan y por Chile, y recién en 1818 Pueyrredón lo rehabilitó, le devolvió el grado y lo nombró Jefe del Estado Mayor —siete años después de la caída, cuando el Triunvirato que lo había expulsado ya había sido a su vez desplazado —la revolución devoraba sus propias estructuras con una regularidad que empezaba a verse como patrón, no como accidente. Participó en campañas menores. Nadie le prestó demasiada atención. El hombre cuya firma en la Primera Junta abrió el capítulo más importante de estas tierras se volvió figura del pasado durante su propia vida.",
